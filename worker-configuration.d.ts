/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a3d1eff15a03c6fc3caaa3741bd38801)
// Runtime types generated with workerd@1.20260507.1 2026-05-01 global_fetch_strictly_public
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		TURNSTILE_CLIENT: string;
		TURNSTILE_SERVER: string;
	}
}
